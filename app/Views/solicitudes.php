                    ...
                    <div class="modal-body">
                        <div class="row g-3">
                            <div class="col-md-4 form-floating">
                                <input type="number" class="form-control" id="txt_id_solicitud" name="txt_id_solicitud"
                                    placeholder="No. de Solicitud">
                                <label for="txt_id_solicitud">No. de Solicitud</label>
                            </div>
                            <div class="col-md-4 form-floating">
                                <input type="text" class="form-control" id="txt_id_adoptante" name="txt_id_adoptante"
                                    placeholder="No. de adoptante">
                                <label for="txt_id_adoptante">No. de Adoptante</label>
                            </div>
                            <div class="col-md-4 form-floating">
                                <input type="text" class="form-control" id="txt__id_animal" name="txt__id_animal"
                                    placeholder="No. de mascota">
...
<footer class="text-center mt-4 mb-3 text-secondary">
    Refugio de Animales © <?= date('Y'); ?> | Sistema de Gestión de Solicitudes
</footer>
