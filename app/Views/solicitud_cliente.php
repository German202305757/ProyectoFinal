...
<body class="bg-light">
  ...
  <!-- Aquí iría tu header o navbar si fuera necesario -->
  <!-- <header> ... </header> -->
      ...
      <div class="col-lg-8 col-md-10">
        ...
        <div class="card shadow-sm border-0">
          <div class="card-body p-4 p-md-5">
            ...
            <!--
              Este formulario envía los datos a la URL 'agregar_solicitud'
              Asegúrate de que la función base_url() esté disponible si usas este
              archivo en tu framework PHP.
            -->
            <form action="<?= base_url('agregar_solicitud_cliente'); ?>" method="post">
              ...
              <div class="row g-3">
                ...
                <div class="col-md-6 form-floating">
                  <input type="number" class="form-control" id="txt_id_adoptante" name="txt_id_adoptante"
                    placeholder="No. de adoptante" required  value="<?= session()->get('adoptante') ?>" readonly>
                  <label for="txt_id_adoptante" class="ms-2">No. de Adoptante</label>
                  <small class="form-text text-muted ms-2">ID del usuario que realiza la solicitud.</small>
                </div>

                <!-- ID Animal -->
                <div class="col-md-6 form-floating">
                  <input type="text" class="form-control" id="txt__id_animal" name="txt__id_animal"
                    placeholder="No. de mascota" required value="<?=$datos['id_animal'];?>" readonly>
                ...
                <!-- Fecha -->
                <div class="col-md-6 form-floating">
                  <input type="date" class="form-control" id="txt_fecha" name="txt_fecha" placeholder="Fecha" required value="<?php echo date("Y-m-d"); ?>">
                  <label for="txt_fecha">Fecha de Solicitud</label>
                </div>

                <!-- Correo (del formulario original) -->
                ...
                <!-- Comentario (Mejorado a <textarea>) -->
                <div class="col-12 form-floating">
                  ...
                  <label for="txt_comentario">Indique la razón de la adopción y el espacio disponible para la mascota</label>
                </div>
