        ...
        <form action="<?= base_url('agregarregistro'); ?>" method="post">
          <div class="modal-body">
            <div class="form-floating mb-3">
              <input type="number" class="form-control" id="txt_id_historial" name="txt_id_historial" placeholder="Código de Historial">
              <label for="txt_id_historial">Código de Registro</label>
            </div>

            <div class="form-floating mb-3">
              <input type="number" class="form-control" id="txt_id_animal" name="txt_id_animal" placeholder="Código de la mascota">
              <label for="txt_id_animal">Código de mascota</label>
            </div>

            <div class="form-floating mb-3">
              <input type="text" class="form-control" id="txt_vacunas" name="txt_vacunas" placeholder="Vacunas">
              <label for="txt_vacunas">Vacunas</label>
            </div>

            <div class="form-floating mb-3">
              <input type="text" class="form-control" id="txt_tratamiento" name="txt_tratamiento" placeholder="Tratamiento">
              <label for="txt_tratamiento">Tratamiento</label>
            </div>

            <div class="form-floating mb-3">
              <input type="date" class="form-control" id="txt_fecha" name="txt_fecha" placeholder="Fecha del Tratamiento">
