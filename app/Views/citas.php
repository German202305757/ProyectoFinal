...
<body>
    ...
    <div class="container my-5">
        <h1 class="display-4 text-primary fw-bold text-center mb-4"> Citas </h1>
        ...
        <div id="petCarousel" class="carousel slide mb-4" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="https://www.shutterstock.com/image-photo/cropped-image-handsome-male-veterinarian-600nw-2159923499.jpg"
                        class="d-block w-100" alt="Perro en adopción" style="max-height: 400px; object-fit: cover;">
                </div>
                <div class="carousel-item">
                    <img src="https://www.shutterstock.com/image-photo/ginger-cat-looking-camera-lounges-600nw-2532742995.jpg"
        ...
        <table class="table mt-4">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="<?= base_url('eliminar_citas/') . $citas['id_cita']; ?>"
                            class="btn btn-danger btn-sm d-flex align-items-center justify-content-center gap-1"><i
                                class="bi bi-x-circle-fill"></i> Eliminar </a>
                        <div class="mt-1"></div>
                        <a href="<?= base_url('buscar_citas/') . $citas['id_cita']; ?>"
        ...
        <footer class="text-center mt-4 mb-3 text-secondary">
            Refugio de Animales © <?= date('Y'); ?> | Sistema de Gestión de Citas
        </footer>
    </div>
    <?php
    } 
