...
INSERT INTO solicitudes (id_adoptante, id_animal, estado_solicitud, fecha_solicitud, comentario) VALUES
(1, 1, 'aprobada', '2025-01-10', 'Primer solicitante. Excelente perfil.'),
(2, 1, 'rechazada', '2025-01-11', 'Segundo solicitante para Luna. Se priorizó a Juan.'),
(3, 3, 'pendiente', '2025-01-15', 'Solicitud para Coco. En espera de entrevista.'),
(4, 4, 'en proceso', '2025-01-16', 'Solicitud para Michi. Entrevista agendada.'),
(5, 5, 'aprobada', '2025-01-18', 'Perfil apto para Rocky. Pendiente de papeleo final.'),
(6, 2, 'aprobada', '2025-01-20', 'Solicitud para Milo. Aprobada, ya está adoptado.'),
(7, 7, 'pendiente', '2025-01-22', 'Interesado en Thor. Verificando antecedentes.'),
(8, 8, 'aprobada', '2025-01-25', 'Solicitud para Kiara. Aprobada.'),
(9, 9, 'pendiente', '2025-01-26', 'Pregunta por Zeus. Pendiente de visita domiciliaria.'),
( 10, 10, 'aprobada', '2025-01-28', 'Solicitud aprobada para Pipo. Excelente hogar.'),
( 11, 11, 'rechazada', '2025-01-30', 'No cumple con requisitos para Gala.'),
( 12, 12, 'pendiente', '2025-02-01', 'Solicitud para Simba. En revisión.'),
( 13, 13, 'en proceso', '2025-02-05', 'Solicitud para Roco. Visita en curso.'),
( 14, 14, 'aprobada', '2025-02-08', 'Solicitud para Bella. Aprobada.'),
( 15, 15, 'pendiente', '2025-02-10', 'Solicitud para Kira. Pendiente.'),
( 16, 16, 'en proceso', '2025-02-12', 'Max: Solicitud en proceso de documentación.'),
( 17, 17, 'aprobada', '2025-02-15', 'Sasha: Solicitud aprobada.'),
( 18, 18, 'pendiente', '2025-02-17', 'Leo: Solicitud recibida.'),
( 19, 19, 'aprobada', '2025-02-20', 'Toby: Aprobada, perfil excelente.'),
( 20, 20, 'rechazada', '2025-02-22', 'Cleo: Rechazada por falta de experiencia con la raza.'),
( 21, 21, 'aprobada', '2025-02-25', 'Oliver: Aprobada.'),
( 22, 22, 'pendiente', '2025-03-01', 'Oso: Solicitud en espera.'),
( 23, 23, 'en proceso', '2025-03-05', 'Mia: En proceso, visita domiciliaria.'),
( 24, 24, 'aprobada', '2025-03-08', 'Bolt: Aprobada.'),
( 25, 25, 'pendiente', '2025-03-10', 'Fiona: Solicitud recibida.'),
( 1, 26, 'rechazada', '2025-03-12', 'Juan: Segunda solicitud. Se sugiere esperar.'),
( 3, 27, 'pendiente', '2025-03-15', 'Coco: Segunda solicitud para otro animal.'),
( 5, 28, 'aprobada', '2025-03-18', 'Rocky: Segunda mascota aprobada.'),
( 7, 29, 'pendiente', '2025-03-20', 'Thor: Solicitud para Balú.'),
( 9, 30, 'aprobada', '2025-03-22', 'Zeus: Solicitud para Nina. Aprobada.');
